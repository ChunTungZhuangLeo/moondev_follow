...
SWARM_MODELS = {
    # 🌙 Moon Dev's Active Swarm Models - Using all 5 available models!
    "deepseek": (True, "deepseek", "deepseek-chat"),  # DeepSeek Chat - Fast & cheap!
    ...
    "openai": (True, "openai", "gpt-4o"),  # GPT-4o - OpenAI's best
    "gemini": (True, "gemini", "gemini-2.5-flash"),  # Gemini 2.5 Flash - Google's fast model
    "groq": (True, "groq", "llama-3.3-70b-versatile"),  # Groq Llama 3.3 70B - Super fast inference!

    # 🔇 Disabled Models (need additional API keys)
    #"xai": (True, "xai", "grok-4-fast-reasoning"),  # Needs GROK_API_KEY
    #"openrouter_qwen": (True, "openrouter", "qwen/qwen3-max"),  # Needs OPENROUTER_API_KEY
    #"openrouter_glm": (True, "openrouter", "z-ai/glm-4.6"),  # Needs OPENROUTER_API_KEY
    #"openrouter_gpt5_mini": (True, "openrouter", "openai/gpt-5-mini"),  # Needs OPENROUTER_API_KEY
