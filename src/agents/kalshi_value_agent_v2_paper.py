...
class KalshiValueAgent:
    ...
    def __init__(self, live_mode: bool = False):
        ...
        # Authenticated client for live mode - MUST create BEFORE executor
        ...
        if live_mode:
            try:
                ...
                exec_mode = ExecutionMode.PAPER  # Fall back to paper mode
        ...
        self.executor = KalshiTradeExecutor(
            ...
            auth_client=self.auth_client  # Pass auth_client to executor!
        )
